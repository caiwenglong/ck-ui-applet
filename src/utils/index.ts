...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'https://appd.ckscm.com.cn/api'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'https://appd.ckscm.com.cn/api'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'https://appd.ckscm.com.cn/api'
